...
SimpleCNN performed worse but on par with pretrained models like GoogleNET with more 3 million parameters that have near perfect performance of 99% accuracy on the PlantVillage dataset [Szegedy et. al, 2015](10.1109/CVPR.2015.7298594) [Mohanty et al., 2016](10.3389/fpls.2016.01419). Another similar methodology used a hybrid of a convolutional network and a support vector machine performs with 99% accuracy [@10.3389/fpls.2024.1412988].
