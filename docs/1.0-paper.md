...
Our model performs better relative to the best model evaluated by the authors of DiaMOS [@10.48550/arXiv.1905.11946, pg. 6] with an accuracy 86.05% trained for both disease detection and symptom identification.

On par with GoogleNET, a network with more than 3 million parameters with an accuracy of 99% trained for the same task [@10.1109/CVPR.2015.7298594; @10.3389/fpls.2016.01419, pg. 7]. Another similar methodology used a hybrid of a convolutional network and a support vector machine that performs with 99% accuracy [@10.3389/fpls.2024.1412988].
