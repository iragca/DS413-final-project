...
We perform four main tasks and evaluate their performance on the MegaPlant dataset. Disease detction for binary classification, symptom identification for multi-class classification, a single model approach for multi-class classification of both symptoms and a healthy class.
