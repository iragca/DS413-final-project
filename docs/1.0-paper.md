...
:::{table} Perfomance of combined task classificaiton with SimpleCNN
:label: table-4
:align: center
...
Symptom identification may fatally fail if there are more than symptom present on the leaf.
