...
In laboratory diagnostics, several scientific tests are employed to accurately identify pathogens:
  ...
  • **Molecular techniques (PCR, qPCR, LAMP)** – Detect pathogen DNA or RNA, offering high sensitivity and specificity ([Ward et al., 2004](https://onlinelibrary.wiley.com/doi/10.1111/j.1744-7348.2004.tb00352.x); Schaad et al., 2003).
